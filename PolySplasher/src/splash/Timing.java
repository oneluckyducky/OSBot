...
/**
 * Static utility class with various methods that are related to time / timing.
 * 
 * @author The Viking
 *
 */
public class Timing {
	 ...
	 * 
	 * @param mark
	 *            The initial time mark we're calculating from
	...
	/**
	 * Returns the current time in ms. Essentially just a shorter wrapper for
	...
	/**
	 * This method waits for a specific condition to be true within a maximum
	 * amount of time. Your basic conditional sleep. This method uses the
	 * LCondition interface, so it provides lambda support
	 * 
	 * @param condition
	 *            the condition to wait for
	 * @param cycleTime
	 *            the time, in ms, between condition checks
	 * @param timeout
	 *            the maximum time to wait for the condition to be true
	 * @return true if the condition was met within the threshold, or false if
